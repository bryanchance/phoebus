...
{/if}
      ...
      <span class="alignright" style="margin-top: 2px; margin-right: 15px;">
        <form id="addonSearchForm" method="get" action="/search/">
            <input type="text" class="addonSearchInput" name="terms" placeholder="Find add-ons..." size="22" maxlength="64"> <input type="submit" value="Search" class="addonSearchButton">
        </form>
      </span>
      </div>
      <div id="PM-Content">
